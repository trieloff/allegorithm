...
- **Evaluator** — Lexical scope, closures, and the contradiction-producing `if`: when a condition is Both, both branches execute and the disagreement is returned as a first-class value
